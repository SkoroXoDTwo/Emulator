...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ScreenWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ScreenWidget_t qt_meta_stringdata_ScreenWidget = {
    {
QT_MOC_LITERAL(0, 12), // "ScreenWidget"
QT_MOC_LITERAL(13, 11), // "toggleFlash"
QT_MOC_LITERAL(25, 0) // ""

    },
    "ScreenWidget\0toggleFlash\0"
};
...
const QMetaObject ScreenWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ScreenWidget.offsetsAndSize,
    qt_meta_data_ScreenWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ScreenWidget_t
, QtPrivate::TypeAndForceComplete<ScreenWidget, std::true_type>
