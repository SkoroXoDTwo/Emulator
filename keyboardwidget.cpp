...
static const int s_button_position[40][3] {
    { 0,  0, 3 },
    { 0,  4, 3 },
    { 0,  8, 3 },
    { 0, 12, 3 },
...
KeyboardWidget::KeyboardWidget(QWidget *parent) : QWidget(parent)
{
    ...
    setLayout(layout);
    for (int i = 0; i < 40; ++i){
        ZXPushButton * button = new ZXPushButton(s_button_bits[i][0],
                                                 s_button_bits[i][1], this);
        ...
        layout->addWidget(button, s_button_position[i][0],
                                  s_button_position[i][1], 1,
                                  s_button_position[i][2]);
