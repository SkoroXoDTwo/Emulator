...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Port1F_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Port1F_t qt_meta_stringdata_Port1F = {
    {
QT_MOC_LITERAL(0, 6) // "Port1F"
...
const QMetaObject Port1F::staticMetaObject = { {
    QMetaObject::SuperData::link<BusDevice::staticMetaObject>(),
    qt_meta_stringdata_Port1F.offsetsAndSize,
    qt_meta_data_Port1F,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Port1F_t
, QtPrivate::TypeAndForceComplete<Port1F, std::true_type>
